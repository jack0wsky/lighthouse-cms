...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    industry: Attribute.Enumeration<
      ['streaming', 'ecommerce', 'logistics', 'erp-sap']
    > &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiValuesPageValuesPage extends Schema.SingleType {
  collectionName: 'values_pages';
  info: {
    singularName: 'values-page';
    pluralName: 'values-pages';
    displayName: 'ValuesPage';
    description: '';
  };
  options: {
    draftAndPublish: true;
